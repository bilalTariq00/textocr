...
export const metadata: Metadata = {
  title: "Text Extractor & Formatter",
  description: "Extract text from images with automatic direction detection and formatting for Arabic, Persian, Urdu, and English text",
};
